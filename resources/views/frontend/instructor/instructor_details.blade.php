      ...
      <div class="media media-card align-items-center pb-4">
        <div class="media-img media--img media-img-md rounded-full">
          <img class="rounded-full"
            src="{{ (!empty($instructor->photo)) ? url('storage/upload/instructor_images/'.$instructor->photo) : url('storage/upload/no_image.jpg')}}"
            alt="Student thumbnail image">
        </div>
        <div class="media-body">
          <h2 class="section__title fs-30">{{ $instructor->name }}</h2>
          <span class="d-block lh-18 pt-1 pb-2">Joined {{ Carbon\Carbon::parse($instructor->created_at)->diffForHumans()
            }}</span>
      ...
      <div class="tab-content pt-40px" id="myTabContent">
        <div class="tab-pane fade show active" id="about-me" role="tabpanel" aria-labelledby="about-me-tab">
          <div class="card card-item">
            <div class="card-body">
              <p class="card-text pb-3">There are many variations of passages of Lorem Ipsum available, but the majority
                have suffered alteration in some form, by injected humour, or randomised words which don't look even
                slightly believable. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab corporis est fugiat
                ipsa laboriosam laudantium possimus quo? Aperiam architecto laborum provident rerum, totam ullam!
                Accusantium eius eum perferendis quasi, repellendus suscipit voluptate voluptatem! Delectus dolorem
                maxime nulla numquam quasi quod.</p>
              <p class="card-text pb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias atque ipsa
                magnam, magni nobis quam ratione reiciendis totam? Accusantium aliquam aspernatur, assumenda cupiditate
                deleniti eius, ex fuga iusto minus, nihil perspiciatis porro provident quasi soluta ut! Consequuntur
                earum eos magnam?</p>
              <div class="collapse" id="collapseReadMore">
                <p class="card-text pb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias consequatur
                  consequuntur dolorem enim error est fuga iure magnam voluptas, voluptates.</p>
              </div>
              <a class="collapse-btn collapse--btn fs-15" data-toggle="collapse" href="#collapseReadMore" role="button"
      ...
      <div class="col-lg-4 responsive-column-half">
        <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1{{ $course->id }}">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title"><a href="{{ url('course/details/'.$course->id.'/'.$course->course_name_slug) }}">{{
  ...
  <div id="tooltip_content_1{{ $item->id }}">
    <div class="card card-item">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <a href="#" class="btn theme-btn flex-grow-1 mr-3"><i class="la la-shopping-cart mr-1 fs-18"></i> Add to
            Cart</a>
          <div class="icon-element icon-element-sm shadow-sm cursor-pointer" title="Add to Wishlist"><i
              class="la la-heart-o"></i></div>
        </div>
