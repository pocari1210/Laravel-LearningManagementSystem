                ...
                <div class="card">
                  <div class="card-header" id="heading{{ $sec->id }}">
                    <button class="btn btn-link d-flex align-items-center justify-content-between"
                      data-toggle="collapse" data-target="#collapse{{ $sec->id }}" aria-expanded="true"
              ...
              <div class="media media-card">
                <div class="instructor-img">
                  ...
                  <ul class="generic-list-item pt-3">
                    ...
                    <li><i class="la la-play-circle-o mr-2 text-color-3"></i> {{ count($instructorCourses) }} Courses
                    </li>
                ...
                <div class="media-body">
                  ...
                  <p class="pb-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                  ...
                  <div class="collapse" id="collapseMoreTwo">
                    <p class="pb-3">After learning the hard way, Tim was determined to become the best teacher he could,
                      and to make his training as painless as possible, so that you, or anyone else with the desire to
                      become a software developer, could become one.</p>
            ...
            <div class="review-wrap">
              ...
              <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                ...
                <div class="media-body">
                  ...
                  <p class="pb-2">This is one of the best courses I have taken in Udemy. It is very complete, and it has
                    made continue learning about Java and SQL databases as well.</p>
              ...
              <div class="preview-course-feature-content pt-40px">
                ...
                <div class="preview-course-incentives">
                  ...
                  <ul class="generic-list-item pb-3">
                    <li><i class="la la-play-circle-o mr-2 text-color"></i>{{ $course->duration }} hours on-demand video
                    </li>
          ...
          <div class="card card-item">
            <div class="card-body">
              ...
              <ul class="generic-list-item generic-list-item-flash">
                ...
                <li class="d-flex align-items-center justify-content-between"><span><i
                      class="la la-lightbulb mr-2 text-color"></i>Skill level</span> {{ $course->label }}</li>
                <li class="d-flex align-items-center justify-content-between"><span><i
            ...
            <div class="card-body">
              ...
              <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                ...
                <div class="media-body">
                  ...
                  @else
                  <p class="text-black font-weight-semi-bold lh-18 fs-15">${{ $related->discount_price }} <span
    ...
    <div class="modal-content">
      <div class="modal-header border-bottom-gray">
        <div class="pr-2">
          ...
          <h5 class="modal-title fs-19 font-weight-semi-bold lh-24" id="previewModalTitle">{{ $course->course_name }}
          </h5>
        </div>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true" class="la la-times"></span>
