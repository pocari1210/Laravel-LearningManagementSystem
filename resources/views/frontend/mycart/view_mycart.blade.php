      ...
      <table class="table generic-table">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <a href="course-details.html" class="text-black font-weight-semi-bold">The Complete Financial Analyst
                Course 2019</a>
              <p class="fs-14 text-gray lh-20">By <a href="teacher-detail.html" class="text-color hover-underline">Mark
                  Hardson</a>, Master Digital Marketing: Strategy, Social Media Marketing, SEO, YouTube, Email, Facebook
                Marketing, Analytics &amp; More!</p>
            </td>
            <td>
            ...
            <td>
              <button type="button" class="icon-element icon-element-xs shadow-sm border-0" data-toggle="tooltip"
