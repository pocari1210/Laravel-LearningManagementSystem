                    ...
                    <ul>
                      <li>
                        <div class="shop-cart-btn">
                          <div class="avatar-xs">
                            <img class="rounded-full img-fluid" src="{{ (!empty($profileData->photo)) ? url('storage/upload/user_images/'.$profileData->photo) : url('storage/upload/no_image.jpg')}}" alt="Avatar image">
                          </div>
                          <span class="dot-status bg-1"></span>
                        </div>
                        <ul class="cart-dropdown-menu after-none p-0 notification-dropdown-menu">
